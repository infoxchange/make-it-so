...
export class IxTroubleshootingBastion extends Construct {
    ...
    constructor(scope, id, { allowSshFrom = ["0.0.0.0/0"], securityGroup, packages = [], ...bastionProps } = {}) {
        ...
        this.bastion = new BastionHostLinux(this, `${id}-Bastion`, {
            ...
            machineImage: MachineImage.latestAmazonLinux2023({
                cpuType: instanceType.architecture === InstanceArchitecture.ARM_64
    ...
    installPackages(packages) {
        ...
        if (deployConfig.vpcHttpProxy) {
            userData.addCommands(`export http_proxy=${deployConfig.vpcHttpProxy}`, `export https_proxy=${deployConfig.vpcHttpProxy}`, `export no_proxy=169.254.169.254,localhost,127.0.0.1`);
        }
